...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if ($result->num_rows > 0) {
    ...
    if ($password == $row["password"]) { //database mei jo password hai $row[password] woh match karraha hai $password jo user ne form mein dia hai aur humne usko variable $password mein dala hai
